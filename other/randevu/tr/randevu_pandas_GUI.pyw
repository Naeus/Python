...
import pandas as pd
import randevu_pandas as rd_pd
rd_pd.avail_times_for_a_grp_siz = rd_pd.musait_saatler
...
if __name__ == "__main__":
    try:
        ...
        sub_root = tk.Tk()
        tk.Label(sub_root, text="Warning: data.py wasn't found!").pack()
    ...
    root = Rendezvous(saatler, randevular)
